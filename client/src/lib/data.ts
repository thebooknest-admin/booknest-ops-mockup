...
export const books: Book[] = [
  {
    ...
    sku: "BN-FLD-0597",
    isbn: "9781949474497",
    title: "Fiona Flamingo",
    author: "Rachael Urrutia Chu",
    ageGroup: "Fledglings (3-5)",
    bin: "FLD-HRT-01",
    status: "In House",
    receivedDate: "3/16/2026",
  },
...

  {
    ...
    sku: "BN-SOR-0705",
    isbn: "9781368028165",
    title: "Olaf and the Three Polar Bears",
    author: "Calliope Glass",
    ageGroup: "Soarers (6-8)",
    bin: "SOR-ADV-01",
    status: "In House",
    receivedDate: "3/13/2026",
  },

  {
    ...
    sku: "BN-FLD-0587",
    isbn: "9781945200267",
    title: "Daydream with Max and Molly",
    author: "Todd Courtney",
    ageGroup: "Fledglings (3-5)",
    bin: "FLD-WON-01",
    status: "Damaged",
    receivedDate: "3/16/2026",
...

  {
    ...
    sku: "BN-FLD-0579",
    isbn: "9781338826449",
    title: "The Grinny Granny Donkey",
    author: "Craig Smith",
    ageGroup: "Fledglings (3-5)",
    bin: "FLD-HUM-01",
    status: "In House",
...

  {
    ...
    ageGroup: "Sky Readers (9-12)",
    bin: "SKY-ADV-01",
    status: "In House",
    receivedDate: "3/10/2026",
  },

  {
    ...
    ageGroup: "Hatchlings (0-2)",
    bin: "HAT-HRT-01",
    status: "In House",
    receivedDate: "3/8/2026",
  },
...
export const bins: BinData[] = [
  // Hatchlings
  { bin: "HAT-ADV-01", ageGroup: "Hatchlings (0-2)", topic: "Adventure", count: 0 },
  { bin: "HAT-HUM-01", ageGroup: "Hatchlings (0-2)", topic: "Laughs & Chaos", count: 0 },
  { bin: "HAT-HRT-01", ageGroup: "Hatchlings (0-2)", topic: "Heart & Home", count: 0 },
  { bin: "HAT-WON-01", ageGroup: "Hatchlings (0-2)", topic: "Wonder & Imagination", count: 0 },
  { bin: "HAT-WLD-01", ageGroup: "Hatchlings (0-2)", topic: "Wild & Wonderful", count: 0 },
  { bin: "HAT-DSC-01", ageGroup: "Hatchlings (0-2)", topic: "Discovery Den", count: 0 },
  { bin: "HAT-LEG-01", ageGroup: "Hatchlings (0-2)", topic: "Legends & Long Ago", count: 0 },
  { bin: "HAT-SEA-01", ageGroup: "Hatchlings (0-2)", topic: "Seasons & Celebrations", count: 0 },

  // Fledglings
  { bin: "FLD-ADV-01", ageGroup: "Fledglings (3-5)", topic: "Adventure", count: 0 },
  { bin: "FLD-HUM-01", ageGroup: "Fledglings (3-5)", topic: "Laughs & Chaos", count: 0 },
  { bin: "FLD-HRT-01", ageGroup: "Fledglings (3-5)", topic: "Heart & Home", count: 0 },
  { bin: "FLD-WON-01", ageGroup: "Fledglings (3-5)", topic: "Wonder & Imagination", count: 0 },
  { bin: "FLD-WLD-01", ageGroup: "Fledglings (3-5)", topic: "Wild & Wonderful", count: 0 },
  { bin: "FLD-DSC-01", ageGroup: "Fledglings (3-5)", topic: "Discovery Den", count: 0 },
  { bin: "FLD-LEG-01", ageGroup: "Fledglings (3-5)", topic: "Legends & Long Ago", count: 0 },
  { bin: "FLD-SEA-01", ageGroup: "Fledglings (3-5)", topic: "Seasons & Celebrations", count: 0 },

  // Soarers
  { bin: "SOR-ADV-01", ageGroup: "Soarers (6-8)", topic: "Adventure", count: 0 },
  { bin: "SOR-HUM-01", ageGroup: "Soarers (6-8)", topic: "Laughs & Chaos", count: 0 },
  { bin: "SOR-HRT-01", ageGroup: "Soarers (6-8)", topic: "Heart & Home", count: 0 },
  { bin: "SOR-WON-01", ageGroup: "Soarers (6-8)", topic: "Wonder & Imagination", count: 0 },
  { bin: "SOR-WLD-01", ageGroup: "Soarers (6-8)", topic: "Wild & Wonderful", count: 0 },
  { bin: "SOR-DSC-01", ageGroup: "Soarers (6-8)", topic: "Discovery Den", count: 0 },
  { bin: "SOR-LEG-01", ageGroup: "Soarers (6-8)", topic: "Legends & Long Ago", count: 0 },
  { bin: "SOR-SEA-01", ageGroup: "Soarers (6-8)", topic: "Seasons & Celebrations", count: 0 },

  // Sky Readers
  { bin: "SKY-ADV-01", ageGroup: "Sky Readers (9-12)", topic: "Adventure", count: 0 },
  { bin: "SKY-HUM-01", ageGroup: "Sky Readers (9-12)", topic: "Laughs & Chaos", count: 0 },
  { bin: "SKY-HRT-01", ageGroup: "Sky Readers (9-12)", topic: "Heart & Home", count: 0 },
  { bin: "SKY-WON-01", ageGroup: "Sky Readers (9-12)", topic: "Wonder & Imagination", count: 0 },
  { bin: "SKY-WLD-01", ageGroup: "Sky Readers (9-12)", topic: "Wild & Wonderful", count: 0 },
  { bin: "SKY-DSC-01", ageGroup: "Sky Readers (9-12)", topic: "Discovery Den", count: 0 },
  { bin: "SKY-LEG-01", ageGroup: "Sky Readers (9-12)", topic: "Legends & Long Ago", count: 0 },
  { bin: "SKY-SEA-01", ageGroup: "Sky Readers (9-12)", topic: "Seasons & Celebrations", count: 0 },
];
