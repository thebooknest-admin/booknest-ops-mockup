...
function TagSelector({
  ...
  return (
    <div className="space-y-4">
          ...
          return (
            ...
            >
              <button
                type="button"
                onClick={() =>
                  setExpandedCat(isOpen && !search ? null : cat.id)
                }
      ...
      <p className="text-[10px] text-muted-foreground">✦ = suggested tags</p>
    </div>
  );
}
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isSelected ? "border-current" : "border-border/60 bg-card"
                )}
                style={
                  isSelected
                    ? {
                  ...
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[10px] text-muted-foreground mt-1 font-mono">
                        {buildBinName(ageGroup || "Fledglings (3-5)", cat.id)}
                      </p>
                    </div>
                  </div>
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="page-header mb-0">
          ...
          <p className="page-subtitle">
            Scan an ISBN to pull book details, suggest an age group, and
            organize inventory.
          </p>
        </div>
            ...
            <div key={s} className="flex items-center flex-1">
              <div className="flex flex-col items-center">
                <div
                  ...
                  style={
                    i <= step ? { backgroundColor: "oklch(0.42 0.11 155)" } : {}
                  }
                >
      ...
      <div className="grid lg:grid-cols-[minmax(0,1fr)_360px] gap-6 items-start">
        <main className="space-y-6">
                  ...
                  <div className="flex-1 space-y-3">
                    <div>
                      ...
                      >
                        ...
                        <p>
                          This title falls outside Book Nest age ranges and
                          should not be included in member boxes.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        onClick={() => {
                          toast.info(
                            "Book marked for donation — scan next book."
                          );
                          handleReset();
                        }}
          ...
          {step === 1 && book && isManualEntry && (
            <div className="rounded-3xl bg-card border border-border/70 shadow-sm p-6 space-y-5">
              ...
              >
                ...
                <p className="text-xs leading-relaxed">
                  Without an ISBN lookup, tags are selected manually in the next
                  step.
                </p>
              </div>
              ...
              <div className="flex gap-3 pt-1">
                ...
                <button
                  ...
                  onClick={() => setStep(2)}
                  disabled={
                    !book.title.trim() || !book.author.trim() || !ageGroup
                  }
          ...
          {step === 2 && ageGroup && (
            <div className="rounded-3xl bg-card border border-border/70 shadow-sm p-6 space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-0.5">
                  Review the suggested classification, then adjust anything
                  before saving.
                </p>
              </div>
          ...
          {step === 3 && (
            <div className="rounded-3xl bg-card border border-border/70 shadow-sm p-6 space-y-5">
              <div>
                <h2 className="font-semibold text-foreground">Save Book</h2>
