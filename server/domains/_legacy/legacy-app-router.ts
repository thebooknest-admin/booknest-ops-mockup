...
export const legacyAppRouter = router({
  ...
  // ─── Inventory ──────────────────────────────────────────────────────────────
  inventory: router({
    summary: operatorProcedure.query(async () => {
    ...
    bins: operatorProcedure.query(async () => {
  ...
  // ─── Labels ─────────────────────────────────────────────────────────────────
  labels: router({
    pending: operatorProcedure.query(async () => {
  ...
  // ─── QC Queue ────────────────────────────────────────────────────────────────
  qc: router({
    queue: operatorProcedure.query(async () => {
    ...
    count: operatorProcedure.query(async () => {
  ...
  returns: router({
    ...
    openRequests: operatorProcedure.query(async () => {
      const returns = await sbJson<
        {
          id: string;
